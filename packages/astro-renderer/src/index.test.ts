...
test("separa en carriles radiales los planetas que están muy próximos", () => {
  const base = { birthData: { date: "", time: "", timeZone: "", latitude: 0, longitude: 0 }, time: { localDateTime: "", utcDateTime: "", julianDayUT: 0, timeZone: "" }, houses: { ascendant: 0, midheaven: 0, cusps: Array.from({ length: 12 }, (_, index) => index * 30) } };
